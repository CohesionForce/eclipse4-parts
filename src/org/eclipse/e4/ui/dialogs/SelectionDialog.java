...
public abstract class SelectionDialog extends TrayDialog {
	...
	static String SELECT_ALL_TITLE = JFaceResources.getString("SelectionDialog_selectLabel"); //$NON-NLS-1$ 

	static String DESELECT_ALL_TITLE = JFaceResources.getString("SelectionDialog_deselectLabel"); //$NON-NLS-1$
