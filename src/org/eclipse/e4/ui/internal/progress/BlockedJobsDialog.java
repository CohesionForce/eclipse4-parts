...
import org.eclipse.e4.ui.internal.progress.BlockedJobsDialog;
...
public class BlockedJobsDialog extends IconAndMessageDialog {
	...
	private class BlockedUIElement extends JobTreeElement {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#getChildren()
		 */
		Object[] getChildren() {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#getDisplayString()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#getDisplayImage()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#hasChildren()
		 */
		boolean hasChildren() {
			return false;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#isActive()
		 */
		boolean isActive() {
			return true;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#isJobInfo()
		 */
		boolean isJobInfo() {
			return false;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#cancel()
		 */
		public void cancel() {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.e4.ui.internal.progress.JobTreeElement#isCancellable()
		 */
...
//					.getLongOperationTime());
	...
	private ProgressViewerContentProvider getContentProvider() {
		return new ProgressViewerContentProvider(viewer, true, false) {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.eclipse.e4.ui.internal.progress.ProgressViewerContentProvider#getElements(java.lang.Object)
			 */
