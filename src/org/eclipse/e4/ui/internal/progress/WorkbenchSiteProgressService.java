...
public class WorkbenchSiteProgressService implements
    ...
    public class SiteUpdateJob extends WorkbenchJob {
         ...
         * (non-Javadoc)
         * 
         * @see org.eclipse.e4.ui.progress.UIJob#runInUIThread(org.eclipse.core.runtime.IProgressMonitor)
         */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.e4.ui.progress.IProgressService#busyCursorWhile(org.eclipse.jface.operation.IRunnableWithProgress)
     */
...
//        getWorkbenchProgressService().busyCursorWhile(runnable);
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.e4.ui.progress.IWorkbenchSiteProgressService#schedule(org.eclipse.core.runtime.jobs.Job,
     *      long, boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.e4.ui.progress.IWorkbenchSiteProgressService#showBusyForFamily(java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.e4.ui.internal.progress.IJobBusyListener#decrementBusy(org.eclipse.core.runtime.jobs.Job)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.e4.ui.internal.progress.IJobBusyListener#incrementBusy(org.eclipse.core.runtime.jobs.Job)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.e4.ui.progress.IWorkbenchSiteProgressService#warnOfContentChange()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.e4.ui.progress.IProgressService#showInDialog(org.eclipse.swt.widgets.Shell,
...
//        getWorkbenchProgressService().run(fork, cancelable, runnable);
    ...
    /*
     *  (non-Javadoc)
     * @see org.eclipse.e4.ui.progress.IProgressService#runInUI(org.eclipse.jface.operation.IRunnableContext, org.eclipse.jface.operation.IRunnableWithProgress, org.eclipse.core.runtime.jobs.ISchedulingRule)
     */
...
//        getWorkbenchProgressService().runInUI(context, runnable, rule);
    ...
    /* (non-Javadoc)
     * @see org.eclipse.e4.ui.progress.IProgressService#getLongOperationTime()
     */
...
//        return getWorkbenchProgressService().getLongOperationTime();
    ...
    /* (non-Javadoc)
     * @see org.eclipse.e4.ui.progress.IProgressService#registerIconForFamily(org.eclipse.jface.resource.ImageDescriptor, java.lang.Object)
     */
...
//        getWorkbenchProgressService().registerIconForFamily(icon, family);
    ...
    /* (non-Javadoc)
     * @see org.eclipse.e4.ui.progress.IProgressService#getIconFor(org.eclipse.core.runtime.jobs.Job)
     */
...
//        return getWorkbenchProgressService().getIconFor(job);
    ...
    /* (non-Javadoc)
     * @see org.eclipse.e4.ui.progress.IWorkbenchSiteProgressService#showBusy(boolean)
     */
